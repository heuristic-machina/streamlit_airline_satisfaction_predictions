...
model_option = st.sidebar.selectbox('Select a model', ['Logistic Regression','Linear SVC', 'Random Forest'])
...
fig, ax = plt.subplots()
ConfusionMatrixDisplay.from_estimator(model, X_test_sc, y_test, ax=ax, cmap='gist_stern')
st.pyplot(fig)
